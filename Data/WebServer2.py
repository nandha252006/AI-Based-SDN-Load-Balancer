...
# CONFIGURATION
# -----------------------------
SERVER_NAME = "Web2"             # Logical server name
CONTAINER_NAME = "Webserver2"     # Prometheus container name
BLACKBOX_TARGET = "localhost:8081"  # Blackbox target for latency
CSV_FILE = "Web2_metrics_full.csv"  # CSV file to save metrics
